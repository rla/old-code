...
$sisu_array["local_title"]="Külalisteraamat";
$sisu_array["pic"]="";

if ($subid=="1") {

	$sisu_array["sisu"]="&nbsp; &nbsp;Lisa ka sissekanne";

	//külalisteraamatu vormi osa
	$sisu_array["in_01"]="Nimi:";
	$sisu_array["in_02"]="Mail:";
	$sisu_array["in_03"]="Weeb:";
	$sisu_array["in_04"]="Tekst:";
	$sisu_array["in_05"]="Vaata sissekandeid";
	...
	for ($i=$s_count; $i<$e_count; $i++) {
		...
		$dynamic=$dynamic .$tyhik ."Nimi: " .$qb_array[0] ."<br>";
		$dynamic=$dynamic .$tyhik ."Mail: " .$qb_array[1] ."<br>";
		$dynamic=$dynamic .$tyhik ."Weeb: " .$qb_array[2] ."<br>";
		$dynamic=$dynamic .$tyhik ."Aeg: " .$qb_array[4] ."<br>";
		$dynamic=$dynamic .$tyhik ."Tekst: " .$qb_array[3] ."</p><hr>";
	}

	$q_link="&nbsp; &nbsp;"; //külalisteraamatus liikumise link
	if ($s_count>0) $q_link=$q_link ."<a href=\"index.php?mis=quest&keel=et&subid=2&subsubid=" .($subsubid-1) ."\" class=\"text\">Tagasi</a>&nbsp; &nbsp;";
	if ($e_count<$count) $q_link=$q_link ."<a href=\"index.php?mis=quest&keel=et&subid=2&subsubid=" .($subsubid+1)  ."\" class=\"text\">Edasi</a>";

	$dynamic=$dynamic .$q_link;

	$sisu_array["sisu"]="&nbsp; &nbsp;Sissekanded " .($s_count+1) ." - " .$e_count .", kokku " .$count;
