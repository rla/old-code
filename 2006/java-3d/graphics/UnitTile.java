 ...
 *
 */
public class UnitTile extends Shape3D {
    public UnitTile(Point3f pos, Texture2D texture, int orientation) {
        ...
        case 0: //paralleelne xy tasandiga, x ja y telje suunas laienev
            ...
            points[2]=new Point3f(pos.x+10, pos.y+10, pos.z);
            points[3]=new Point3f(pos.x+10, pos.y, pos.z);
            break;
        case 1: //paralleelne yz tasandiga, x ja z telje suunas laienev
            points[0]=new Point3f(pos.x, pos.y, pos.z+10);
            points[1]=new Point3f(pos.x, pos.y+10, pos.z+10);
